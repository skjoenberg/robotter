  ...
  : pattern_size (cvSize (3, 4)), patternUnit(50.0f)
{
  ...
  CV_MAT_ELEM(*intrinsic_matrix, double, 0, 0) = 6.2728502118126062e+02;
  CV_MAT_ELEM(*intrinsic_matrix, double, 0, 2) = 3.1157666684838449e+02;
  CV_MAT_ELEM(*intrinsic_matrix, double, 1, 1) = 6.2860881657427467e+02;
  CV_MAT_ELEM(*intrinsic_matrix, double, 1, 2) = 2.3975627437456771e+02;
